...
> **Current version:** `package.json` / `CHANGELOG.md` are authoritative (**v1.8.0** as of 2026-09-05) —
...
> released by `chore(main): release 1.8.0 (#36)` and tagged `v1.8.0` (`03 §27` · traps `T6`–`T8`).
